...
const countNumberOfElements = (arr) => {
  ...
  let result = arr.reduce((acc,ele,index)=>{
...
const reversedString = (str) => {
  ...
  let final = result.reduce((acc,ele)=>{
    console.log(acc);
    return `${acc}${ele}`;
     // could use the join mehtod instead of reduce method to join array ^^
