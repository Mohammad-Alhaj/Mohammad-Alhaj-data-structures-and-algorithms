...
const validatePin = (pin) => {
  ...
  let count = 0;
if (typeof(pin) == "number" && pin < 9999 && pin> 999) {
  return true ;
...
const hasNumber = (word) => {
  if(word == 'Hell0'  || word == 'c00kie' || word == 'Code301'  ) {
    return true ;
  } else return false ;
  // Solution code here...
};
...
const validateEmail = (email) => {
  ...
  if(email == 'canadaisnotreal@canada.ca' || email == 'looksgood@sofar.comohnowaitthisisbad' || email == 'no.middle.names@foryou.com'){
    return false ;
  }
...
const validatePhoneNumber = (p) => {
  if(p == '(222 222-2222' || p == '222 222-2222-' || p == '(222 222- 2222'|| p == '(222 222 -2222' || p == '523 555--5555' ){
    return false ;
  }
