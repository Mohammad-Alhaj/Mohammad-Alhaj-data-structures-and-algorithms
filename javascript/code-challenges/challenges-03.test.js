...
Write a function called addTwo that takes in an array and adds two
 to every value using a for loop. Place the new value in a new array. Return the new array.
------------------------------------------------------------------------------------------------ */
...
const notInFirstArray = (forbiddenValues, arr) => {
  ...
  let result = arr.filter(ele=>{
    ...
    return ele !== forbiddenValues[index] ;
  });
  // console.log(result); 
  return result ;
...
describe('Testing challenge 3', () => {
  test('It should return an array of strings containing the word and', () => {
    expect(containsAnd(['panda', 'ran', 'and'])).toStrictEqual(['panda','ran', 'and']);
