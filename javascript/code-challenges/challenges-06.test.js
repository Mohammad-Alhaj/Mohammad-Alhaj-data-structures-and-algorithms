...
const getNames = (arr) => {
  ...
  let result = arr.map(ele=>{
    let newarr = '' ;
    for (let i = ele.name.length - 1; i>=0; i--) {

      newarr =newarr +ele.name[i] ;     
    }
    //here could use manny of method to reverce the array like reverce method or reduce ....
...
// could use the push mehtod to solve this problem
...
Write a function that accepts an object and an integer as arguments and adds a new property to 
the object called yearBorn. The value of the yearBorn property should be the integer that was passed in.
...
const addBirthYearProperty = (obj, year) => {
  ...
  // another wat to solve this problem by useing Object.assign()
  // let neww = {yearBorn:year} ;

  // let result = obj.assign(obj,neww) ;
  // console.log(result);
